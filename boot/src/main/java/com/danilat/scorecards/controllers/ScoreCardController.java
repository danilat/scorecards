...
public class ScoreCardController {
    ...
    public String listByAccount(@PathVariable String username, Model model, @CookieValue(defaultValue = "", name = "access_token") String accessToken) {
        this.model = model;
        this.model.addAttribute("currentAccount", auth.currentAccountId(accessToken));
